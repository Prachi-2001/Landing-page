...
import ModernizeSec from "./ModernizeSec";
                    ...
                    <div className="flex grow flex-col max-md:max-w-full max-md:mt-10">
                      ...
                      <div className="flex w-[404px] max-w-full items-start justify-between gap-5 self-start max-md:justify-center">
                        <div className="flex flex-col flex-1 mt-2.5">
                          <div className="justify-center text-slate-600 text-center text-xs font-bold leading-5 capitalize underline underline-offset-1 decoration-blue-700  decoration-4 cursor-pointer">
                            Your Cloud
                          </div>
