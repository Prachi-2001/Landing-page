...
function NewsLetter() {
  ...
  return (
    <>
      <div className="backdrop-blur-[20px] bg-blue-200 self-center flex w-full max-w-[1198px]  grow flex-col mt-14 pt-16 pb-24 px-5 rounded-[60px] max-md:max-w-full max-md:mt-10">
        <Image
          loading="lazy"
