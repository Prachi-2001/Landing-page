  ...
  return (
    <div className="bg-white bg-opacity-50 self-stretch flex pt-0 pb-0 flex-col mt-1 max-md:max-w-full">
      <div className="flex-col justify-center items-center overflow-hidden self-center relative z-[1] flex min-h-[1021px] w-full max-w-[1465px] pt-20 pb-[604px] px-5 max-md:max-w-full">
        ...
        <button className="relative justify-end text-white text-center text-xl font-bold leading-8 capitalize self-center items-center cursor-pointer bg-blue-700 mb-0 w-[251px] h-15 py-4   max-w-full mt-9 rounded-md border-2 border-solid border-blue-700 max-md:mb-2.5 hover:bg-blue-500">
          Get Started Now
        </button>
      </div>
    </div>
