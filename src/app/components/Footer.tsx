...
function Footer() {
  return (
    <>
      <div className="items-start backdrop-blur-[20px] bg-blue-200 bg-opacity-10 self-stretch flex w-full flex-col mt-96 mb-24 pt-20 pb-16 px-5 max-md:max-w-full max-md:my-10 hover:text-blue-700">
        <div className="self-center w-full max-w-[1098px] max-md:max-w-full">
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            ...
            <div className="flex flex-col items-stretch w-[69%] ml-5 max-md:w-full max-md:ml-0 cursor-pointer">
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  <div className="flex flex-col items-stretch w-[24%] max-md:w-full max-md:ml-0">
                    <div className="items-start flex grow flex-col max-md:mt-10">
                      <div className="items-start flex w-[111px] max-w-full flex-col self-start cursor-pointer">
